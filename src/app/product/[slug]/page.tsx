...
interface ProductPageProps {
    params: { slug: string };  
    searchParams?: Record<string, string | string[] | undefined>;  // FIXED TYPE
}
        ...
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-col-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col gap-8">
                    <h1 className="text-7xl font-bold mt-10">{product.productName}</h1>
                    <p className="text-4xl font-sans">{product.price}</p>
